...
desc person;
insert into person value('A01','Richard','Srinivas nagar'),('A02','Pradeep','Rajaji nagar'),('A03','Smith','Ashok nagar'),('A04','Venu','NR Colony'),('A05','Jhon','Hanumanth nagar');
select * from person;
...
desc accident;
insert into accident value(11,'2003-01-01','Mysore road'),(12,'2004-02-02','Southend circle'),(13,'2003-01-21','BUll Temple road'),(14,'2008-02-17','Mysore road'),(15,'2003-03-04','Kanakpura road');
select * from accident;

desc own;
insert into owns values('A01','KA052250'),('A02','KA053408'),('A03','KA095477'),('A04','KA031181'),('A05','KA041702');
select * from owns;
...
select * from car order by year asc;
 ...
 select count(*)
 from participated p
 join car c on p.reg_num
 where c.model = 'lancer';
 
 select count(p.reg_num)as count from participated p , c
 where p.reg_num = c.reg_num and c.model = 'lancer';
 
 select count(*)
 from person p
 join participated pa on p.deiver_id = pa.driver_id
